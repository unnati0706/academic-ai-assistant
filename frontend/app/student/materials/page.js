    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">Browse, view, and download verified faculty materials.</p>
        </div>
            ...
            >
              ...
              <div className="pt-4 border-t border-gray-800/80 flex items-center space-x-2">
                {(mat.file_url || mat.file_path || mat.id) && (
                  <a
                    href={getDocumentUrl(mat.file_url || mat.file_path, 'academic-documents', mat.id)}
                    target="_blank"
                    rel="noreferrer"
