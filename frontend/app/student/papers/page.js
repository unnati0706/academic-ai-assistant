  ...
  return (
    <div className="space-y-5 sm:space-y-6 max-w-7xl mx-auto text-[#263339]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-[#263339] tracking-tight">University Question Paper Archive</h1>
          <p className="text-xs text-[#465F64] mt-0.5">Explore previous years' mid-term and university examination papers</p>
        </div>
        ...
        <div className="inline-flex items-center space-x-2 text-xs font-bold px-3 py-1.5 rounded-xl bg-[#E6D9B9] text-[#263339] border border-[#D8D6C9] self-start sm:self-auto">
          <FileText className="w-4 h-4 text-[#749190]" />
      ...
      {loading ? (
        <div className="py-20 flex justify-center items-center space-x-3">
          ...
          <span className="text-xs text-[#465F64] font-semibold">Loading question papers...</span>
        </div>
      ) : papers.length === 0 ? (
        <div className="bg-white rounded-2xl p-10 sm:p-12 text-center border border-[#D8D6C9] shadow-xs">
          <FileText className="w-12 h-12 text-[#749190]/40 mx-auto mb-3" />
          <h3 className="text-sm font-bold text-[#263339]">No question papers found</h3>
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  {paper.year && (
                    <div className="flex items-center space-x-1 text-[11px] text-[#465F64] bg-[#fbf9f5] px-2 py-0.5 rounded-md border border-[#D8D6C9] font-medium">
                      <Calendar className="w-3 h-3 text-[#749190]" />
                ...
                <p className="text-[11px] text-[#749190] font-bold mt-1">{paper.subject_name || paper.subject_code || 'Computer Science'}</p>
              </div>
